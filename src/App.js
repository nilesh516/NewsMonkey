      ...
      <Router>
        <Navbar/>
          ...
          <Routes>
            ...
            <Route exact path="/NewsMonkey" element= {<News setProgress={this.setProgress} apiKey={this.apiKey}  key="general1" pageSize={this.pageSize} country = 'in' category = 'general'/>} />
